...
Till varje meddelandet som en myndighet skickar till sammanställningsprogrammet ska HTTP‑headern X-Correlation-ID inkluderas. Också användare av system för utlämnande av uppgifter ska ange X-Correlation-ID i sin svar till system för utlämnande av uppgifter. Identifieraren ska anges i formatet UUIDv4. Applikationen använder denna information för att koppla varje meddelandet som hör till samma förfrågan. X-Correlation-ID ska vara densamma i varje meddelandet som hör till samma förfrågan. Förfrågan tilldelas ett X-Correlation-ID när en ny förfrågan görs till Query‑gränssnittet. Därefter används samma X-Correlation-ID i varje meddelandet till Status‑ och Result‑gränssnitten.
